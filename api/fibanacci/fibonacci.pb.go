...
func (x *FibonacciResponse) GetMessage() []string {
	if x != nil {
		return x.Message
	}
	return nil
...
var file_fibonacci_proto_rawDesc = []byte{
	...
	,
...
var file_fibonacci_proto_depIdxs = []int32{
	0, // 0: fibonacci.Fibonacci.GetFibSlice:input_type -> fibonacci.FibonacciRequest
	1, // 1: fibonacci.Fibonacci.GetFibSlice:output_type -> fibonacci.FibonacciResponse
...
func (c *fibonacciClient) GetFibSlice(ctx context.Context, in *FibonacciRequest, opts ...grpc.CallOption) (*FibonacciResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fibonacci.Fibonacci/GetFibSlice", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Fibonacci_GetFibSlice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fibonacci.Fibonacci/GetFibSlice",
	}
